...
* Moved rviz configurations to ridgeback_viz.
...
* Modified AMCL's parameters, map and demo for Ridgeback.
* Modified slam_gmapping parameters for Ridgeback for building a map.
